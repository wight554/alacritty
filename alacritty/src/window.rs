...
impl Window {
    ...
    pub fn set_fullscreen(&mut self, fullscreen: bool) {
        if self.is_simple_fullscreen || self.is_fullscreen == fullscreen {
            return;
        }

        self.is_fullscreen = !self.is_fullscreen && fullscreen;
    ...
    pub fn set_simple_fullscreen(&mut self, simple_fullscreen: bool) {
        if self.is_fullscreen || self.is_simple_fullscreen == simple_fullscreen {
            return;
        }

        self.is_simple_fullscreen = simple_fullscreen;
